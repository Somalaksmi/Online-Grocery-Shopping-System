...
<header style="background-color: white;">
        <nav class="navbar navbar-expand navbar-light ">
            ...
            <div class="collapse navbar-collapse " id="navbarNavDropdown">
                ...
                <li class="nav-item ">
                    <a class="nav-link active" style="color: rgb(226, 147, 1); text-transform: uppercase;" href="product.php">&nbsp;Product</a>
                </li>
                <li class="nav-item ">
    ...
    <section class="container content" style="margin-bottom: 50;">
        <h2 class="section-header">LIST</h2>
        <div class="cart-row">
            <span class="cart-item cart-header cart-column">ITEM</span>
            <span class="cart-desc cart-header cart-column">DESCRIPTION</span>
        ...
        <button class="btn btn-primary btn-purchase" type="button" onClick="<script src='product.js'>purchaseClicked()</script>">SAVE</button>
    </section>
